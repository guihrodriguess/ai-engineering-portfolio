...
| 2 | [Agente com ferramentas e controle de execução](./02-agente-ferramentas-controle-execucao) | Tool calling, estado, retry/timeout, idempotência, tracing, Human-in-the-Loop | 🟢 Em desenvolvimento |
